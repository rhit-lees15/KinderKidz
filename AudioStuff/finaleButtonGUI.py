...
########################
       ...
       # Button for songs
        ...
        audio_button_1.place(relx=0.4, rely=0.4, anchor=tk.CENTER)
        ...
        audio_button_2.place(relx=0.8, rely=0.4, anchor=tk.CENTER)
        ...
        audio_button_3.place(relx=0.4, rely=0.6, anchor=tk.CENTER)
        ...
        audio_button_4.place(relx=0.8, rely=0.6, anchor=tk.CENTER)
