...
########################
       ...
       # Button for songs
        ...
        audio_button_1.place(relx=0.2, rely=0.2, anchor=tk.CENTER)
        ...
        audio_button_2.place(relx=0.6, rely=0.2, anchor=tk.CENTER)
        ...
        audio_button_3.place(relx=0.2, rely=0.4, anchor=tk.CENTER)
        ...
        audio_button_4.place(relx=0.6, rely=0.4, anchor=tk.CENTER)
        ...
        audio_button_5.place(relx=0.5, rely=0.6, anchor=tk.CENTER)
