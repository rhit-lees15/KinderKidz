...
def buttonPress(pin):
    global randomWord, randomizedLetters, button_sequence, button_letters
    # spelledWord, 
    ...
    if letter in randomWord:
        ...
        if letter == randomWord[len(self.spelled_word)]:
            ...
            if len(self.spelled_word) == 0:
                ...
                #self.spelled_word = randomWord[incorrect_position]
...
def newWord():
    ...
    availableLetters = list(set(string.ascii_uppercase) - set(self.spelled_word) - set(randomWord))
