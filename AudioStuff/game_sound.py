...
happy_sounds = ['./AudioStuff/90s-game-ui.mp3','./AudioStuff/copper-bell-ding-4.mp3','/AudioStuff/correct-choice','./AudioStuff/cute-level-up-1.mp3','./AudioStuff/cute-level-up-2.mp3','./AudioStuff/cute-level-up-3.mp3','./AudioStuff/game-bonus.mp3','./AudioStuff/level-up.mp3','./AudioStuff/level-up-2.mp3','./AudioStuff/YayKidsCrowd.mp3','./AudioStuff/bonus-points.mp3']
